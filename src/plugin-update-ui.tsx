...
export function PluginUpdateHeader({ locale }: { locale?: PetLocaleStore }) {
  ...
  useEffect(() => {
    ...
    return observePluginUpdate({ root: root.current, endpoint: `${BASE}/api/update`, packageName: '@michengai/dsh-codex-pet', titleRowSelector: '.dcp-project-head', linksSelector: '.dcp-project-links', zhName: '宠物', enName: 'Pets', createIcon: createPluginUpdateIcon });
  }, [language]);
