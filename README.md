...
Supported DeepSeek Harness versions: **`0.1.0-rc.8`, `0.1.1-rc.2`, `0.1.2-rc.1`, `0.1.5-rc.1`, `0.1.5-rc.2`, and `0.1.7-rc.1`**. Alpha hosts are no longer supported; these RC releases remain. Make sure the `dsh` command is available. The example uses the `web` profile; replace it with your target profile.
